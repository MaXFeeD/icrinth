...
Per section 5.2 of [Inner Core Content Rules](https://inner-core.org/legal/rules#miscellaneous) your project slug (URL) must accurately represent your project. `,
        },
      ],
    },
    {
...
Per section 5.3 of [Inner Core Content Rules](https://inner-core.org/legal/rules#miscellaneous) Your project summary should provide a brief overview of your project that informs and entices users.
This is the first thing most people will see about your mod other than the Logo, so it's important it be accurate, reasonably detailed, and exciting.`,
        },
        {
          ...
          resultingMessage: `## Insufficient Summary
Per section 5.3 of [Inner Core Content Rules](https://inner-core.org/legal/rules#miscellaneous) your Summary can not be the same as your project's Title. Your project summary should provide a brief overview of your project that informs and entices users.
This is the first thing most people will see about your mod other than the Logo, so it's important it be accurate, reasonably detailed, and exciting.`,
        },
        {
          name: "Formatting",
          resultingMessage: `## Insufficient Summary
Per section 5.3 of [Inner Core Content Rules](https://inner-core.org/legal/rules#miscellaneous) your Summary can not include any extra formatting such as lists, or links. Your project summary should provide a brief overview of your project that informs and entices users.
This is the first thing most people will see about your mod other than the Logo, so it's important it be accurate, reasonably detailed, and exciting.`,
        },
      ],
    },
...
See descriptions like [Simply Optimized](https://inner-core.org/modpack/sop) or [Aged](https://inner-core.org/modpack/aged) for examples of what a good description looks like.
`,
        },
        {
...
Per section 5.4 of [Inner Core Content Rules](https://inner-core.org/legal/rules#miscellaneous) all links must lead to correctly labeled publicly available resources that are directly related to your project.`,
        },
        {
...
Per section 5.1 of [Inner Core Content Rules](https://inner-core.org/legal/rules#miscellaneous), it is important that the metadata of your projects is accurate. Including that selected tags honestly represent your project.`,
        },
      ],
    },
    {
...
Per section 5.5 of [Inner Core Content Rules](https://inner-core.org/legal/rules#miscellaneous) any images in your project's Gallery must be relevant to the project and also include a Title.`,
        },
      ],
    },
    {
...
It looks like you've uploaded multiple \`mod.icmod\` files to one Version as Additional Files. Per section 5.7 of [Inner Core Content Rules](https://inner-core.org/legal/rules#miscellaneous) each Version of your project must include only one \`mod.icmod\` that corresponds to its respective Minecraft and loader versions. This allows users to easily find and download the file they need for the version they're on with ease. The Additional Files feature can be used for things like a \`Sources.zip\`.
...
Per section 4 of [Inner Core Content Rules](https://inner-core.org/legal/rules) this is strictly forbidden.
