...
// http://localhost:8000/auth/init?url=https://inner-core.org
#[get("init")]
pub async fn init(
    req: HttpRequest,
            ...
            if let Some(id) = user_id {
                ...
                if provider == AuthProvider::PayPal  {
                    ...
                    send_email(
                        ...
                        "If you did not make this change, please contact us immediately through our support channels on Discord or via email (support@inner-core.org).",
                        None,
                    )?;
                }
