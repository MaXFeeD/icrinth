...
<template>
  <div class="flex items-center justify-between gap-4">
    <div>
      ...
      <p class="m-0 text-sm">
        Inner Core Mods ad provider, Aditude, shows ads based on your preferences. By disabling this
  ...
  <div class="mt-4 flex items-center justify-between gap-4">
    <div>
      ...
      <p class="m-0 text-sm">
        Inner Core Mods collects anonymized analytics and usage data to improve our user experience
  ...
  <div class="mt-4 flex items-center justify-between gap-4">
    <div>
      ...
      <p class="m-0 text-sm">
        Manages the Discord Rich Presence integration. Disabling this will cause 'Inner Core' to no
        longer show up as a game or app you are using on your Discord profile.
      </p>
      <p class="m-0 mt-2 text-sm">
        Note: This will not prevent any modpack-specific Discord Rich Presence integrations, such as
        those added by mods. (app restart required to take effect)
      </p>
    </div>
    <Toggle
