...
import { SearchIcon, XIcon, ClipboardCopyIcon, GlobeIcon, ExternalIcon } from '@icmods/assets'
import type { Category, GameVersion, Platform, ProjectType, SortType, Tags } from '@icmods/ui'
import {
  SearchFilterControl,
  SearchSidebarFilter,
  Button,
