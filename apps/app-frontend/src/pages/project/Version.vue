...
<script setup>
import { DownloadIcon, FileIcon, ReportIcon, ExternalIcon, CheckIcon } from '@icmods/assets'
import { formatBytes, renderString } from '@icmods/utils'
import { Breadcrumbs, Badge, Avatar, Card, Button, CopyCode } from '@icmods/ui'
